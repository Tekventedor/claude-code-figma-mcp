...
/* ------------------------------------------------------------------------- */
/* Watermark — FlowHunt mark (path from /Desktop/Flowhunt/flowhunt-mark.svg) */
/* + "Flow" / gradient "Hunt" wordmark.                                       */
/* ------------------------------------------------------------------------- */
...
const Watermark = `function Watermark(props){var R=React.createElement;
  return R('div', { style:{ width:'100%', height:'100%', display:'flex', alignItems:'center', justifyContent:'center', gap:'8px', opacity:0.75, fontFamily:'Inter', fontWeight:700, fontSize:'22px' } },
    R('svg', { width:26, height:21, viewBox:'0 0 275 223' },
      R('defs', null,
